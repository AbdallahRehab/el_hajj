...
class SignUpHajj1 extends StatefulWidget {
  @override
  _SignUpHajj1State createState() => _SignUpHajj1State();
}

class _SignUpHajj1State extends State<SignUpHajj1> {
  bool _isHidden = true;
            ...
            children: <Widget>[
              Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 15,vertical: 4.0),
                      child: buildOtherTextField("Name",Icon(
                        Icons.person,
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 15,vertical: 4.0),
                      child: buildOtherTextField("National ID",Icon(
                        Icons.perm_identity,
                        color: Color(0XFF005B5A),
                      ),),
                    ),
