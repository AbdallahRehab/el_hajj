  ...
  Widget buildTextField(String hintText) {
    return TextFormField(
      validator: (input) {
        ...
        if(!input.contains('@owner.com')){
          return 'please shoud @owner.com ';
        }
      },
        ...
        child: InkWell(
          onTap: (){
            signIn();
              ...
              //Navigator.push(context, MaterialPageRoute(builder: (context)=> CompanyNames())),
          child: Text(
            "LOGIN",
            style: TextStyle(
              color: Colors.white,
