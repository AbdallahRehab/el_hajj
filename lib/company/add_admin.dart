...
//
//  const SignUpAdmin({Key key, this.companyname}) : super(key: key);
...
class _SignUpAdminState extends State<SignUpAdmin> {
  ...
  String _email, _password,_name,_phone,_address,_nationalID,_companywork;
              ...
              Form(
                ...
                child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 15,vertical: 4.0),
                        child: buildTextFieldcompanywork("Company Work",Icon(
                          Icons.work,
                          color: Color(0XFF005B5A),
                        ),),
                      ),
  ...
  Widget buildTextFieldcompanywork(String hintText,Icon icon) {
    return TextFormField(
      validator: (input) {
        if (input.length<3) {
          return 'please type an company';
        }

      },
      onSaved: (input) => _companywork = input,
      decoration: InputDecoration(
          labelText: hintText,
          labelStyle: TextStyle(
              color: Color(0XFF005B5A),
    ...
    if (formState.validate()) {
      ...
      try {
         user = await FirebaseAuth.instance
          ...
          print(user.user.uid);
        ser.addadmin(user,_name,_phone,_address,_nationalID,_companywork);
      } catch (e) {
        print(e.toString());
      }
    }
