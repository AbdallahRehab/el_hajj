...
class HajjDataCom extends StatefulWidget {
 final String name,phone,nid,docid;

  const HajjDataCom({Key key, this.name, this.phone, this.nid, this.docid}) : super(key: key);


  @override
  _HajjDataComState createState() => _HajjDataComState();
}

class _HajjDataComState extends State<HajjDataCom> {
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                FlatButton(
                                  ...
                                  onPressed: () {
                                    //showSnackBar("FlatButton with Color & Shape");
                                    Firestore.instance.collection("user").document(widget.docid).delete();
                                    return Alert(
                                        context: context,
                                        title: "Delete Done",
