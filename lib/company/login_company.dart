...
import 'package:elhajj/company/company_home1.dart';
import 'package:elhajj/company/signup_company.dart';
        ...
        child: InkWell(
          onTap: (){
            signIn();
              ...
              //Navigator.push(context, MaterialPageRoute(builder: (context)=> CompanyHome1())),
          child: Text(
            "LOGIN",
            style: TextStyle(
              color: Colors.white,
